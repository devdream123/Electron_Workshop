...
test("Init the game: active player is set, state is TURNSTART", () => {
  var gso = {
    players: [{ active: true }, { active: false }],
    state: "TURNSTART"
  };
...
test("Give dice to second player - player didn't throw yet, state is DEALT", () => {
  engine.setGSO({
    players: [{ active: false }, { active: true }],
    board: {
      dealt: [],
      thrown: [],
      hand: []
...
test("The turn is over, count points, player 1 was active", () => {
  engine.setGSO({
    players: [{ active: true, score: 0 }, { active: false }],
    board: {
      dealt: [],
      thrown: [],
      hand: [
...
test("The turn is over, count points, player 2 was active", () => {
  engine.setGSO({
    players: [{ active: false }, { active: true, score: 4 }],
    board: {
      dealt: ["dice2", "dice3"],
      thrown: [],
      hand: [{ name: "dice1", side: "cabbage" }]
