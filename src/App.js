    ...
    return (
      <div className="Table">
        <div className="Column">
          <h2
            className={this.state.gso.players[0].active ? "Active" : "Inactive"}
          >
            Player 1
          </h2>
          <Player
            data={this.state.gso.players[0]}
            state={this.state.gso.state}
        ...
        <div className="Column">
          <h2
            className={this.state.gso.players[1].active ? "Active" : "Inactive"}
          >
            Player 2
          </h2>
          <Player
            data={this.state.gso.players[1]}
            state={this.state.gso.state}
            send={this.sendMessage}
          />
        </div>
